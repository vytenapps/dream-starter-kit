...
export interface Config {
  ...
  globalsSelect: {
    ...
    'ext-chat-adapter-sendblue-settings': ExtChatAdapterSendblueSettingsSelect<false> | ExtChatAdapterSendblueSettingsSelect<true>;
    'ext-chat-adapter-slack-settings': ExtChatAdapterSlackSettingsSelect<false> | ExtChatAdapterSlackSettingsSelect<true>;
    'ext-docs-settings': ExtDocsSettingsSelect<false> | ExtDocsSettingsSelect<true>;
  };
  locale: null;
  widgets: {
 ...
 */
export interface ExtChatAdapterSendblueSettingsSelect<T extends boolean = true> {
  enabled?: T;
