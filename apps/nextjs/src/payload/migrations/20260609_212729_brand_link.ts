...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "cms"."theme_settings" ADD COLUMN "brand_link_new_tab" boolean DEFAULT false;
  ALTER TABLE "cms"."theme_settings" ADD COLUMN "brand_link_url" varchar;
  ...
  ALTER TABLE "cms"."_theme_settings_v" ADD COLUMN "version_brand_link_new_tab" boolean DEFAULT false;
  ALTER TABLE "cms"."_theme_settings_v" ADD COLUMN "version_brand_link_url" varchar;`);
}
...
export async function down({
  ...
  ALTER TABLE "cms"."theme_settings" DROP COLUMN "brand_link_new_tab";
  ALTER TABLE "cms"."theme_settings" DROP COLUMN "brand_link_url";
  ALTER TABLE "cms"."_theme_settings_v" DROP COLUMN "version_brand_link_type";
  ALTER TABLE "cms"."_theme_settings_v" DROP COLUMN "version_brand_link_new_tab";
  ALTER TABLE "cms"."_theme_settings_v" DROP COLUMN "version_brand_link_url";
