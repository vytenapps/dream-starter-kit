...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "cms"."enrollments" DROP CONSTRAINT "enrollments_subscription_id_subscriptions_id_fk";
  
  ALTER TABLE "cms"."series_rels" DROP CONSTRAINT "series_rels_plans_fk";
  
  ALTER TABLE "cms"."_series_v_rels" DROP CONSTRAINT "_series_v_rels_plans_fk";
  
  ALTER TABLE "cms"."space_groups_rels" DROP CONSTRAINT "space_groups_rels_plans_fk";
  
  ALTER TABLE "cms"."community_spaces_rels" DROP CONSTRAINT "community_spaces_rels_plans_fk";
  
  ALTER TABLE "cms"."payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_plans_fk";
  
  ALTER TABLE "cms"."payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_coupons_fk";
  
  ALTER TABLE "cms"."payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_subscriptions_fk";
  
  DROP INDEX "cms"."series_rels_plans_id_idx";
  DROP INDEX "cms"."_series_v_rels_plans_id_idx";
  DROP INDEX "cms"."space_groups_rels_plans_id_idx";
  DROP INDEX "cms"."community_spaces_rels_plans_id_idx";
  DROP INDEX "cms"."payload_locked_documents_rels_plans_id_idx";
  DROP INDEX "cms"."payload_locked_documents_rels_coupons_id_idx";
  DROP INDEX "cms"."payload_locked_documents_rels_subscriptions_id_idx";
...
export async function down({
  ...
  ALTER TABLE "cms"."enrollments" DROP CONSTRAINT "enrollments_subscription_id_ext_billing_subscriptions_id_fk";
  
  ALTER TABLE "cms"."series_rels" DROP CONSTRAINT "series_rels_ext_billing_plans_fk";
  
  ALTER TABLE "cms"."_series_v_rels" DROP CONSTRAINT "_series_v_rels_ext_billing_plans_fk";
  
  ALTER TABLE "cms"."space_groups_rels" DROP CONSTRAINT "space_groups_rels_ext_billing_plans_fk";
  
  ALTER TABLE "cms"."community_spaces_rels" DROP CONSTRAINT "community_spaces_rels_ext_billing_plans_fk";
  
  ALTER TABLE "cms"."payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_ext_billing_plans_fk";
  
  ALTER TABLE "cms"."payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_ext_billing_coupons_fk";
  
  ALTER TABLE "cms"."payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_ext_billing_subscriptions_fk";
  
  DROP INDEX "cms"."series_rels_ext_billing_plans_id_idx";
  DROP INDEX "cms"."_series_v_rels_ext_billing_plans_id_idx";
  DROP INDEX "cms"."space_groups_rels_ext_billing_plans_id_idx";
  DROP INDEX "cms"."community_spaces_rels_ext_billing_plans_id_idx";
  DROP INDEX "cms"."payload_locked_documents_rels_ext_billing_plans_id_idx";
  DROP INDEX "cms"."payload_locked_documents_rels_ext_billing_coupons_id_idx";
  DROP INDEX "cms"."payload_locked_documents_rels_ext_billing_subscriptions__idx";
